#!/bin/bash
source /opt/ros/jazzy/setup.bash 2>/dev/null || source /home/chakradhar/Documents/Hardware/ros2_ws/install/setup.bash 2>/dev/null
...
if [ "$1" == "--sim" ] || [ "$1" == "1" ]; then
    ...
    ros2 launch /home/chakradhar/Documents/Hardware/urdf/unnamed/display_ros2.launch.py simulate:=true
elif [ "$1" == "--gazebo" ] || [ "$1" == "3" ]; then
    echo "🌐 Starting Gazebo Physics Simulation..."
    ros2 launch /home/chakradhar/Documents/Hardware/urdf/unnamed/gazebo_ros2.launch.py
else
    echo "================================================================="
