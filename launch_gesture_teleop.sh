...
(ros2 run robot_state_publisher robot_state_publisher --ros-args -p robot_description:="$(cat /home/sabo/Documents/learn_/Hardware/urdf/unnamed/urdf/unnamed_gazebo.urdf)" &)

# 3. Start RViz2 3D Digital Twin Visualization
(rviz2 -d /home/sabo/Documents/learn_/Hardware/urdf/unnamed/robot.rviz &)
